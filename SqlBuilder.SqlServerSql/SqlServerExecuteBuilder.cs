...
namespace SqlBuilder.SqlServer
{
    ...
    internal class SqlServerExecuteBuilder<TModel> : AbstractSqlServerBuilder<TModel>, ISqlRawExecuteBuilder<TModel> where TModel : class
    {
        /// <summary>
        /// 以現有建構器初始化執行建構器。
        /// </summary>
        /// <param name="builder">抽象建構器實例。</param>
        public SqlServerExecuteBuilder(AbstractSqlServerBuilder builder) : base(builder)
        {
        }
        ...
        public SqlServerExecuteBuilder(DbContext dbContext) : base(dbContext)
        {
        }
        ...
        public ISqlRawDeleteBuilder<TModel> SqlRawFoDelete()
        {
            ...
            return new SqlServerDeleteBuilder<TModel>(this);
        }
        ...
        public ISqlRawUpdateBuilder<TModel> SqlRawForUpdate()
        {
            ...
            return new SqlServerlUpdateBuilder<TModel>(this);
        }
        ...
        {
            return new SqlServerExecuteBuilder<TModel2>(this).SqlRawFoDelete();
        }
        ...
        {
            return new SqlServerExecuteBuilder<TModel2>(this).SqlRawForUpdate();
        }
        ...
        public int ExecuteSqlRaw()
        {
            ...
            return _dbContext.Database
                .ExecuteSqlRaw(_sb.ToString(), _parameters.Select(m => new SqlParameter
                {
                    ParameterName = $"@P_{_parameters.IndexOf(m)}",
                    Value = m
                }));
        }
